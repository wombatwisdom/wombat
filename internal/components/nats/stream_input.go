...
func (j *jetStreamReader) nextMsg(ctx context.Context, timeout time.Duration) (jetstream.Msg, error) {
...
func (j *jetStreamReader) claim(jsMsg jetstream.Msg) (service.AckFunc, error) {
    if j.claimHeader == "" {
