...
generated based on their composition. For more information check out the [metrics documentation](cmp-metrics.mdx).
...
All processing errors result in the messages being flagged as failed, [error metrics](cmp-metrics.mdx) increasing for the
