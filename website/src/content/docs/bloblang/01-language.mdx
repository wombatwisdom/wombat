...
following [the walkthrough first](00-getting_started.mdx).
...
For more information about these operators and how they work check out [the arithmetic page](02-arithmetic).
