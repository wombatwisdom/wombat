...
in [function interpolations](/pipelines/learn/interpolation).
...
following [the walkthrough first](../getting_started).
...
For more information about these operators and how they work check out [the arithmetic page](../arithmetic).
...
outlined [in this document](/pipelines/test).
