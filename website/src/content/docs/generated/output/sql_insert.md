...
| `columns` | `array` | `` | A list of columns to insert. |
| `args_mapping` | `string` | `` | A xref:guides:bloblang/about.adoc[Bloblang mapping] which should evaluate to an array of values matching in size to the number of columns specified. |
| `prefix` | `string` | `` | An optional prefix to prepend to the insert query (before INSERT). |
| `suffix` | `string` | `` | An optional suffix to append to the insert query. |
