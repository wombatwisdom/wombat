...
| `key` | `string` | `` | The key for each message, function interpolations should be used to create a unique key per message. |
...
| `fields` | `object` | `{}` | A map of key/value pairs to set as hash fields. |
