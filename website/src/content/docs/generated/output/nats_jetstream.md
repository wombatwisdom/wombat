...
| `subject` | `string` | `` | A subject to write to. |
| `headers` | `object` | `{}` | Explicit message headers to add to messages. |
...
| `max_in_flight` | `int` | `1024` | The maximum number of messages to have in flight at a given time. Increase this to improve throughput. |
