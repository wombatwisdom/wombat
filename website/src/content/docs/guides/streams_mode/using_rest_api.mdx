...
By using the Wombat `streams` mode REST API you can dynamically control which streams are active at runtime. The full spec for the Wombat streams mode REST API can be [found here][http-interface].
