...
[bloblang.interpolation]: /pipelines/learn/interpolation/#bloblang-queries
[kafka.input]: /reference/components/inputs/kafka_franz
[kafka.input.metadata]: /reference/components/inputs/kafka_franz/#metadata
[kafka.input.regex]: /reference/components/inputs/kafka_franz#regexp_topics
[kafka.output]: /reference/components/outputs/kafka_franz