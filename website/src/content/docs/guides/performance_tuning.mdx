...
Some processors within Wombat are relatively heavy on your CPU, and can potentially become the bottleneck of a service. In these circumstances it is worth configuring Wombat so that your processors are running on each available core of your machine without contention.
...
[pipeline]: /pipelines/build/pipeline
[batching]: /pipelines/learn/batching
[buffers]: /pipelines/build/buffers
[broker-input]: /reference/components/inputs/broker
[broker-output]: /reference/components/outputs/broker
