...
[sync-res]: /reference/components/outputs/sync_response
[sync-res-proc]: /reference/components/processors/sync_response
[http-client-output]: /reference/components/outputs/http_client
[output-broker]: /reference/components/outputs/broker