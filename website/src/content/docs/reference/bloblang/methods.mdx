...
Splits text into segments from a given string based on the unicode text segmentation rules.
...
Splits a string into different sentences
...
Splits a string into different graphemes
...
Returns the number bitwise AND-ed with the specified value.
...
Returns the number bitwise OR-ed with the specified value.
...
Returns the number bitwise eXclusive-OR-ed with the specified value.
...
*`no_indent`* &lt;bool, default `false`&gt; Disable indentation.  
*`root_tag`* &lt;(optional) string&gt; Root tag. Set this if you wish to override the root tag of the document.  
...
# In:  {"-foo":"bar","fizz":"buzz"}
# Out: <doc foo="bar">
#          <fizz>buzz</fizz>
#      </doc>

# In:  {"foo":[{"bar":"baz"},{"fizz":"buzz"}]}
# Out: <doc>
#          <foo>
#              <bar>baz</bar>
#          </foo>
