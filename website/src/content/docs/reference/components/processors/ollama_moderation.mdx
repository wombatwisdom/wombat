...
<Tabs>
<TabItem label="Use Llama Guard 3 classify a LLM response">
...
| Option | Summary |
| ------ | ------- |
| `llama-guard3` | When using llama-guard3, two pieces of metadata is added: @safe with the value of `yes` or `no` and the second being @category for the safety category violation. For more information see the [Llama Guard 3 Model Card](https://ollama.com/library/llama-guard3). |
