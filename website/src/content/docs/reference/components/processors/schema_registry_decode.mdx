...
Whether avro messages should be decoded into normal JSON ("json that meets the expectations of regular internet json") rather than [JSON as specified in the Avro Spec](https://avro.apache.org/docs/current/specification/_print/#json-encoding).
