---
title: legacy_redpanda_migrator_offsets
kind: input
---
...
Redpanda Migrator consumer group offsets input using the [Franz Kafka client library](https://github.com/twmb/franz-go).
