...
<Tabs>
<TabItem label="Updating Documents">
...
<TabItem label="Indexing documents from Redpanda">
...
<TabItem label="Indexing documents from S3">
...
<TabItem label="Upserting Documents">
