...
)([`log`](/reference/bloblang/functions#uuid_v4) string in a metadata field called
`request_id`, log it via the )([here](/reference/components/processors/log) processor and
